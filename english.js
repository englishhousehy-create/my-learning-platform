...
{
  "name": "English House Portal",
  "description": "Premium LMS platform for English teachers and students by Mr. Mohamed Salah, featuring drag-and-drop auto-correct tests, video limits, and student dashboards.",
...
View your app in AI Studio: https://ai.studio/apps/8a127c74-00d4-45f3-9e4a-93da171ba0cc
...
git add assets/ src/ .gitignore index metadata.json package.json package-lock.json README.md server vite.config
git commit -m "رفع الملفات الأساسية المحددة للمشروع"
